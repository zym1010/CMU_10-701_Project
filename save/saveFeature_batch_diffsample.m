function [ suffixArray ] = saveFeature_batch_diffsample( numberArray )
...
for i = 1:length(numberArray)
    ...
    suffix = saveFeature_train_diffsample(numbers(1), numbers(2),...
        numbers(3),numbers(4), numbers(5), numbers(6), numbers(7),...
        numbers(8), numbers(9), numbers(10), numbers(11));
    
    saveFeature_test_diffsample(numbers(1), numbers(2),...
        numbers(3),numbers(4), numbers(5), numbers(6), numbers(7),...
        numbers(8), numbers(9), numbers(10), numbers(11));
