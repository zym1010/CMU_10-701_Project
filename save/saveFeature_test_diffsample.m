function [ suffix ] = saveFeature_test_diffsample( main_flag, overlap_flag, ...
...
if main_flag
    test_feature_main_sample = [test_feature_main(:,1:fft_count:33) ...
        test_feature_main(:,34:fft_count:66) test_feature_main(:,67:fft_count:99)];
