function [ suffix ] = saveFeature_train_diffsample( main_flag, overlap_flag, ...
...
suffix = getsuffix([main_flag, overlap_flag, ...
    timehist_flag, entropy_flag, mean_flag, var_flag, std_flag, diff_flag, ...
    acc_flag, valhist_flag, 64/fft_count]);
...
if main_flag
    train_feature_main_sample = [train_feature_main(:,1:fft_count:33) ...
        train_feature_main(:,34:fft_count:66) train_feature_main(:,67:fft_count:99)];
